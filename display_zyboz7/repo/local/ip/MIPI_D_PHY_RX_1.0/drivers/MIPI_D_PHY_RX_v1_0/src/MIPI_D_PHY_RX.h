...
#define MIPI_D_PHY_RX_S_AXI_LITE_SLV_REG0_OFFSET 0
#define MIPI_D_PHY_RX_S_AXI_LITE_SLV_REG1_OFFSET 4
#define MIPI_D_PHY_RX_S_AXI_LITE_SLV_REG2_OFFSET 8
#define MIPI_D_PHY_RX_S_AXI_LITE_SLV_REG3_OFFSET 12
 ...
 *
 */
XStatus MIPI_D_PHY_RX_Reg_SelfTest(void * baseaddr_p);
