...
## TRIGOUT False Paths
##
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[3]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_temp_reg*" && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[5]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_reg*" && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[3]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_reg*" && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[5]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_temp_reg*" && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[2]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_temp_reg*" && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/u_ila_regs/reg_7/I_EN_CTL_EQ1.U_CTL/xsdb_reg_reg[2]*" && IS_SEQUENTIAL}] -to [get_cells -hierarchical -filter { NAME =~  "*ila_core_inst/I_EN_TRIGOUT.ext_trig_out_reg*" && IS_SEQUENTIAL}]
